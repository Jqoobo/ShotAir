...
if (iconString.value === 'Dla Ciebie') icon.value = 'mdi:home'
if (iconString.value === 'Obserwowane') icon.value = 'ci:group'
if (iconString.value === 'Na żywo') icon.value = 'ri:live-line'
</script>
